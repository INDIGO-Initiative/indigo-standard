...
latex_documents = [
    (master_doc, 'sphinx.tex', 'INDIGO Data Specification',
...
man_pages = [
    (master_doc, 'sphinx', 'INDIGO Data Specification',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sphinx', 'INDIGO Data Specification',
     author, 'Open Data Services Co-operative', 'A data model for describing social impact bonds.',
     'Miscellaneous'),
]
